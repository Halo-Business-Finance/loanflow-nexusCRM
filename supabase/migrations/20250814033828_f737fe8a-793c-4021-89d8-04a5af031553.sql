...
-- Drop and recreate the get_masked_profile_data function
...
BEGIN
  ...
  ELSE
    ...
    RETURN jsonb_build_object(
      'id', profile_data->>'id',
      'first_name', LEFT(COALESCE(profile_data->>'first_name', ''), 1) || '***',
      'last_name', LEFT(COALESCE(profile_data->>'last_name', ''), 1) || '***',
