-- Check if user_role enum exists and create it
CREATE TYPE IF NOT EXISTS public.user_role AS ENUM ('agent', 'manager', 'admin', 'super_admin');

-- Check if user_roles table exists and create it
