        ...
        <nav className="flex items-center justify-center space-x-6">
          {navigationItems.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                to={item.path}
                className={`relative flex items-center gap-2 px-3 py-1.5 text-sm font-mono font-medium transition-colors hover:text-blue-600 hover:bg-blue-50 rounded-md ${
                  isActive 
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button 
                variant="ghost" 
                className={`flex items-center gap-2 px-3 py-1.5 text-sm font-mono font-medium transition-colors hover:text-blue-600 hover:bg-blue-50 rounded-md ${
