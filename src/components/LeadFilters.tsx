...
const stages = ["All", "New Lead", "Initial Contact", "Loan Application Signed", "Waiting for Documentation", "Pre-approval", "Qualified", "Loan Approved", "Closing", "Loan Funded", "Archive"]
